...
rootkit_radar.mod.o: $(deps_rootkit_radar.mod.o)

$(deps_rootkit_radar.mod.o):

rootkit_radar.mod.o: $(wildcard /usr/lib/modules/6.19.6-arch1-1/build/tools/objtool/objtool)
